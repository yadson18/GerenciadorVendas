...
class ClienteFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_cliente_pessoa1_idx' => ['type' => 'index', 'columns' => ['pessoa_id'], 'length' => []],
            'fk_cliente_usuario1_idx' => ['type' => 'index', 'columns' => ['criado_por'], 'length' => []],
            'fk_cliente_usuario2_idx' => ['type' => 'index', 'columns' => ['alterado_por'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'id_unique' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
            'pessoa_id_unique' => ['type' => 'unique', 'columns' => ['pessoa_id'], 'length' => []],
            'fk_cliente_pessoa1' => ['type' => 'foreign', 'columns' => ['pessoa_id'], 'references' => ['pessoa', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_cliente_usuario1' => ['type' => 'foreign', 'columns' => ['criado_por'], 'references' => ['usuario', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_cliente_usuario2' => ['type' => 'foreign', 'columns' => ['alterado_por'], 'references' => ['usuario', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
